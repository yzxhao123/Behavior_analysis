...
def main(config):
    ...
    checkpoint = torch.load("D:\\yzx\\yolo_slowfast-master\\byte_track\\configs\\charadas\\checkpoint_epoch_00030.pyth")
    ...
    ava_labelnames, _ = AvaLabeledVideoFramePaths.read_label_map(
        "D:\\yzx\\yolo_slowfast-master\\byte_track\\configs\\charadas\\class.txt")
    ...
    while not cap.end:
        ...
        deepsort_tracker = BYTETracker(args, frame_rate=30)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, default="D:/yzx/yolo_slowfast-master/demo/palace.mp4",
                        help='test imgs folder or video or camera')
    parser.add_argument('--output', type=str, default="1.mp4",
