...
import sys
from PyQt5.QtCore import QTimer, QEvent,Qt,QThread, pyqtSignal
import picture_fun
...
class MainWindow(QWidget,Mainwindow.Ui_Mainwindow):
    ...
    def controller(self):
        ...
        self.pushButton_4.clicked.connect(self.switch3)
...
class FramePage1(QWidget, Mainwindow.Ui_Formwin2):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def fun1(self):
        ...
        src = qimage2mat(qimg)
        newsrc, result_text = picture_fun.detect_img(src,model)
        ...
        self.jieguo.append(result_text)


class FramePage2(QWidget, Mainwindow.Ui_Formwin4):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        ...
        self.pushButton_save.clicked.connect(self.save_results_to_txt)
...
# class FramePage3(QWidget, Mainwindow.Ui_Formwin4):
#     def __init__(self):
#         super().__init__()
#         self.setupUi(self)
#         self.pushButton_load.clicked.connect(self.openimage)
...
#
#
class FramePage3(QWidget, Mainwindow.Ui_Formwin6):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.pushButton_load.clicked.connect(self.openimage)
