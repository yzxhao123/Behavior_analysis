    ...
    while not cap.end:
        ...
        if len(cap.stack) == 25:
            ...
            if yolo_preds.pred[0].shape[0]:
                print(yolo_preds.pred[0].shape[0])
...
if __name__=="__main__":
    ...
    parser.add_argument('--input', type=str, default="D:/yzx/yolo_slowfast-master/milu-1.mp4", help='test imgs folder or video or camera')
